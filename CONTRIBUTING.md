...
2. `$ yarn run setup` to verify your system and install dependencies
...
`exercises-final` files easier. Any `exercises` or `exercise-final` folder is actually generated code via the
`split` script. So any changes you make should go in a `workshop-templates` directory. When you've made your changes,
